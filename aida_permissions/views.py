...
from .serializers import (
    PermissionSerializer, PermissionCategorySerializer,
    RoleSerializer, RolePermissionSerializer, UserRoleSerializer,
    AssignRoleSerializer, BulkAssignRoleSerializer, UserPermissionsSerializer
)
...
class PermissionCategoryViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [IsAuthenticated, AidaPermission]
...
class PermissionViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [IsAuthenticated, AidaPermission]
    filter_backends = [DjangoFilterBackend, filters.SearchFilter, filters.OrderingFilter]
    filterset_fields = ['category', 'permission_type', 'resource', 'is_active', 'is_system', 'requires_object']
    search_fields = ['codename', 'name', 'description', 'resource']
    ordering_fields = ['codename', 'name', 'resource', 'created_at']
...
class RoleViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [IsAuthenticated, AidaPermission]
    filter_backends = [DjangoFilterBackend, filters.SearchFilter, filters.OrderingFilter]
    filterset_fields = ['role_type', 'is_active', 'is_default']
    search_fields = ['name', 'display_name', 'description']
